...
public class Myjinjufragment extends BaseFragment {
    ...
    private Myclassjinjuadapter myclassjinjuadapter;
                ...
                .execute(new JsonCallback<GoldBean>(GoldBean.class) {
                    ...
                    public void onSuccess(Response<GoldBean> response) {
                        ...
                        if (code >= 200 && code <= 204){
                            ...
                            myclassjinjuadapter = new Myclassjinjuadapter(getActivity(),list);
    ...
    public void myEvent(EventBean eventBean) {
        if (eventBean.getMsg().equals("jinju")) {
            requestJinJu();
            myclassjinjuadapter.notifyDataSetChanged();
        }
    }
    ...
    public class Myclassjinjuadapter extends RecyclerView.Adapter<Myclassjinjuadapter.Myviewholder> {
        ...
        public Myviewholder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            Myviewholder myviewholder = new Myclassjinjuadapter.Myviewholder(view);
            return myviewholder;
        }
