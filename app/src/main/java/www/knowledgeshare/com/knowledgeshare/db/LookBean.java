...
public class LookBean extends DataSupport{
    ...
    public LookBean(int id, String type, String title, String t_name, String t_tag, String price) {
        this.id = id;
        this.type = type;
        this.title = title;
        this.t_name = t_name;
    ...
    public LookBean(int id, String type, String title, String t_tag, String price) {
        this.id = id;
        this.type = type;
        this.title = title;
        this.t_tag = t_tag;
