...
public class HomeBean {
    ...
    public static class XiaokeEntity {
        ...
        public void setXk_teacher(String xk_teacher) {
            this.xk_teacher = xk_teacher;
        }
